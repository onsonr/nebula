...
export default css`
  ...
  .sl-theme-dark {
    ...
    --sl-color-cyan-50: hsl(197, 84%, 12%);
    --sl-color-cyan-100: hsl(197, 84%, 19%);
    --sl-color-cyan-200: hsl(197, 84%, 27%);
    --sl-color-cyan-300: hsl(197, 83%, 33%);
    --sl-color-cyan-400: hsl(197, 83%, 40%);
    --sl-color-cyan-500: hsl(197, 84%, 48%);
    --sl-color-cyan-600: hsl(198, 100%, 59%);
    --sl-color-cyan-700: hsl(198, 100%, 73%);
    --sl-color-cyan-800: hsl(198, 100%, 83%);
    --sl-color-cyan-900: hsl(198, 100%, 90%);
    --sl-color-cyan-950: hsl(195, 100%, 97%);
    ...
    --sl-color-primary-50: hsl(197, 84%, 12%);
    --sl-color-primary-100: hsl(197, 84%, 19%);
    --sl-color-primary-200: hsl(197, 84%, 27%);
    --sl-color-primary-300: hsl(197, 83%, 33%);
    --sl-color-primary-400: hsl(197, 83%, 40%);
    --sl-color-primary-500: hsl(197, 84%, 48%);
    --sl-color-primary-600: hsl(198, 100%, 59%);
    --sl-color-primary-700: hsl(198, 100%, 73%);
    --sl-color-primary-800: hsl(198, 100%, 83%);
    --sl-color-primary-900: hsl(198, 100%, 90%);
    --sl-color-primary-950: hsl(195, 100%, 97%);
